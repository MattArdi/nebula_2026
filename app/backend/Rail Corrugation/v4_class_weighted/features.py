"""
Rail Corrugation Subsystem (v4, class-weighted ensemble) — Feature Extraction
================================================================================
Unchanged from v3 -- this version's only change is in model.py (per-class
ensemble weighting instead of a single scalar weight per model). Feature
extraction is identical: v2's 41 time-domain features plus v3's 8
frequency-domain features (FFT energy in the 0-100 Hz band), 49 total.
